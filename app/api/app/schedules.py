...
async def list_my_schedules(
    ...
    for entry in entries:
        ...
        item: dict = {
            ...
            # 전환기 datetime 인코딩 (앱이 우선 소비, 없으면 구 필드 fallback)
            "operating_day": entry.operating_day,
...
async def get_my_schedule(
    ...
    result: dict = {
        ...
        "operating_day": response_entry.operating_day,
        "start_at": response_entry.start_at,
        "end_at": response_entry.end_at,
        "break_start_at": response_entry.break_start_at,
        "break_end_at": response_entry.break_end_at,
