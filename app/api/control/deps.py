"""Control plane 인증 의존성 — org 권한 시스템과 완전 독립.

Auth helpers for the control plane. Reads the signed session cookie only —
no JWT, no org/role lookup. This is the separate operator plane.
"""

from fastapi import Request

from app.api.control.session import verify_session

# 세션 쿠키 이름 — devtools 가독성 위해 대문자 접두사 (feedback_uppercase_keys 정신)
COOKIE_NAME: str = "HTM_CP_SESSION"
